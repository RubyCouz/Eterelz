 ...
 */
final class Version20200605123936 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE eter_product ADD product_description VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE eter_user CHANGE statut statut TINYINT(1) DEFAULT NULL, CHANGE user_update user_update DATETIME NOT NULL, CHANGE user_role user_role VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE eter_user CHANGE statut statut TINYINT(1) DEFAULT \'1\' NOT NULL, CHANGE user_update user_update DATETIME DEFAULT NULL, CHANGE user_role user_role VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'utilisateur\' NOT NULL COLLATE `utf8mb4_unicode_ci`');
