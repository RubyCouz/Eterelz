 ...
 */
final class Version20200617075446 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE eter_user ADD user_desactivate TINYINT(1) NOT NULL, CHANGE statut statut TINYINT(1) DEFAULT NULL, CHANGE user_update user_update DATETIME NOT NULL, CHANGE user_role user_role VARCHAR(255) NOT NULL, CHANGE date_inscr date_inscr INT NOT NULL, CHANGE date_lien date_lien INT NOT NULL');
